...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    reclaim = {0, 0},
    map = '/maps/beach_survival_ee.v0007/beach_survival_ee.scmap',
    save = '/maps/beach_survival_ee.v0007/beach_survival_ee_save.lua',
    script = '/maps/beach_survival_ee.v0007/beach_survival_ee_script.lua',
    norushradius = 100,
    Configurations = {
        ['standard'] = {
            teams = {
