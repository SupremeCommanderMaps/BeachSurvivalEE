...
ScenarioInfo = {
    ...
    map = '/maps/beach_survival_ee.v0006/beach_survival_ee.scmap',
    save = '/maps/beach_survival_ee.v0006/beach_survival_ee_save.lua',
    script = '/maps/beach_survival_ee.v0006/beach_survival_ee_script.lua',
    norushradius = 100,
    Configurations = {
        ['standard'] = {
            teams = {
